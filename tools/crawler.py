...
async def main(module_name: str):
    """크롤러 도구의 메인 함수.
    ...
    """
    if module_name == "arca":
        crawler_instance = crawler.ArcaLiveCrawler("arcalive_hotdeal", ["https://proxy.krepe90.workers.dev/proxy?proxyUrl=https://arca.live/b/hotdeal"])
    elif module_name == "ppomppu":
        crawler_instance = crawler.PpomppuCrawler("ppomppu_crawler", ["https://www.ppomppu.co.kr/zboard/zboard.php?id=ppomppu"])
    elif module_name == "ppomppu_rss":
        crawler_instance = crawler.PpomppuRSSCrawler("ppomppu_rss_crawler", ["https://www.ppomppu.co.kr/rss.php?id=ppomppu"])
    elif module_name == "ruliweb":
        crawler_instance = crawler.RuliwebCrawler("ruliweb_crawler", ["https://bbs.ruliweb.com/market/board/1020?view=thumbnail&page=1"])
